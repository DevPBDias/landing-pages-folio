...
const FooterMidia = () => {
  return (
    <div className="flex flex-col gap-4 justify-start items-start max-[1024px]:items-center">
      <h1 className="font-bold text-xl max-[1024px]:text-lg">Mídias Sociais</h1>
